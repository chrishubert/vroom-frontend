...
var panelControl = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    headerDiv.innerHTML = '<a href="https://www.ruterute.com/"><img style="height: 100px" src="../../images/ruterute.png" alt="Rute²" /></a>';
    ...
    header.innerHTML = '<b>Create a new route by:</b>'

    var list = document.createElement('ul');
    var clickEl = document.createElement('li');
    clickEl.innerHTML = 'clicking on the map to create delivery locations;';
    list.appendChild(clickEl);
    var uploadEl = document.createElement('li');
    uploadEl.innerHTML = 'Add multiple couriers by using the "clone" option in the Top Right';
    list.appendChild(uploadEl);

    var jsonUploadEl = document.createElement('li');
    jsonUploadEl.innerHTML = 'Generate the routing by clicking the cog icons on the left side of the screen.';
